...
VALUES
    ...
    ('Sub002',N'الهندسة المدنية', 2,  1,  1),
    ('Sub003',N'الرياضيات المتقدمة', 3,  1,  1),
    ('Sub004',N'الذكاء الاصطناعي', 1, 1,  1),
    ('Sub005',N'الشبكات', 4, 1,  1),
    ('Sub006',N'تحليل النظم', 2,  2,  1),
    ('Sub007',N'قواعد البيانات', 5,  2,  1),
    ('Sub008',N'الفيزياء العامة', 6,  2,  1),
    ('Sub009',N'هندسة البرمجيات', 7,  2,  1),
    ('Sub00A',N'أمن المعلومات', 8,  2,  1);

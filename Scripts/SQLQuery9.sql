...
INSERT INTO Doctors  
VALUES
    ('D001', N'د. محمد يوسف', 'Dr. Mohamed Youssef', 'myoussef', 'pass123', '01123456789',1),
    ('D002', N'د. ندى مصطفى', 'Dr. Nada Mostafa', 'nmostafa', 'pass456', '01098765432',1),
    ('D003', N'د. سامي إبراهيم', 'Dr. Sami Ibrahim', 'sibrahim', 'pass789', '01234567890',1),
    ('D004', N'د. هالة فوزي', 'Dr. Hala Fawzy', 'hfawzy', 'pass321', '01987654321',1),
    ('D005', N'د. عمرو زكريا', 'Dr. Amr Zakaria', 'azakaria', 'pass654', '01876543210',1),
    ('D006', N'د. ريم نبيل', 'Dr. Reem Nabil', 'rnabil', 'pass111', '01011223344',1),
    ('D007', N'د. كريم عبد الله', 'Dr. Karim Abdallah', 'kabdallah', 'pass222', '01022334455',2),
    ('D008', N'د. ياسمين حسين', 'Dr. Yasmin Hussein', 'yhussein', 'pass333', '01033445566',2),
    ('D009', N'د. حسام كمال', 'Dr. Hossam Kamal', 'hkamal', 'pass444', '01044556677',2),
    ('D010', N'د. نجلاء عادل', 'Dr. Naglaa Adel', 'nadel', 'pass555', '01055667788',2);
...
INSERT INTO Subjects (Sub_Name,Sub_Code, Dr_ID, Ins_ID, FacYearSem_ID)
VALUES
    (N'برمجة الحاسوب','Sub001', 1, 1, 1),
    (N'الهندسة المدنية','Sub001', 2, 2, 1),
    (N'الرياضيات المتقدمة','Sub001', 3, 1, 1),
    (N'الذكاء الاصطناعي','Sub001', 1, 1, 1),
    (N'الشبكات','Sub001', 4, 2, 1),
    (N'تحليل النظم','Sub001', 2, 1, 2),
    (N'قواعد البيانات','Sub001', 5, 1, 2),
    (N'الفيزياء العامة','Sub001', 6, 2, 2),
    (N'هندسة البرمجيات','Sub001', 7, 1, 2),
    (N'أمن المعلومات', 'Sub001',8, 2, 2);

-- إدخال بيانات في جدول Lecture_S
INSERT INTO Lecture 
VALUES
    ('L001', 10,'2025-05-10', 50),
    ('L001', 2,'2025-05-10', 50),
    ('L001', 3,'2025-05-11', 50),
    ('L001', 4,'2025-05-11', 50),
    ('L001', 5,'2025-05-11', 50),
    ('L001', 6,'2025-05-12', 50),
    ('L001', 7,'2025-05-12', 50),
    ('L001', 8,'2025-05-12', 50), 
    ('L001', 9,'2025-05-12', 50);

-- إدخال بيانات في جدول Attendance_T
INSERT INTO Attendance  
VALUES
    (2, 2, 1),  -- حضر أحمد علي في المحاضرة L001
    (2, 2, 0);  -- غابت سارة محمد في المحاضرة L002

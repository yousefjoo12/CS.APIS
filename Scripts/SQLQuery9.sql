...
VALUES
    ...
    (N'الهندسة المدنية','Sub001', 2,  1,  1),
    (N'الرياضيات المتقدمة','Sub001', 3,  1,  1),
    (N'الذكاء الاصطناعي','Sub001', 1, 1,  1),
    (N'الشبكات','Sub001', 4, 1,  1),
    (N'تحليل النظم','Sub001', 2,  2,  1),
    (N'قواعد البيانات','Sub001', 5,  2,  1),
    (N'الفيزياء العامة','Sub001', 6,  2,  1),
    (N'هندسة البرمجيات','Sub001', 7,  2,  1),
    (N'أمن المعلومات', 'Sub001',8,  2,  1);
